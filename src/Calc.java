...
class Main {
    ...
    static void err1(){
        try {
            ...
            String text="Cтрока не €вл€етс€ математической операцией";
    ...
    static void err2(){
        try {
            ...
            System.out.println("¬ведено число вне заданного диапазона");
            System.exit(0);
        }
        }
    static void err3(){
        try {
            ...
            System.out.println("¬ведены не числа");
            System.exit(0);
        }
        }
    static void err4(){
        try {
            ...
            String text="Ќе введен второй операнд";
            text+="\n или присутствует пробел!";
            System.out.println(text);
            System.exit(0);
        }
    ...
    static void err5(){
        try {
            ...
            System.out.println("Ќе введен первый операнд");
            System.exit(0);
        }
        }
    static void err6(){
        try {
            ...
            System.out.println("»спользуютс€ одновременно разные системы счислени€");
            System.exit(0);
        }
        }
    static void err7(){
        try {
            ...
            System.out.println("¬ римской системе нет отрицательных чисел и нол€");
            System.exit(0);
        }
        }
    static void err8(){
        try {
            ...
            System.out.println("‘ормат математической операции не удовлетвор€ет заданию - два операнда и один оператор (+, -, /, *)");
            System.exit(0);
        }
        }
